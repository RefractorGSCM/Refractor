...
func (_m *RCONClient) Disconnect() error {
	ret := _m.Called()
...
func (_m *RCONClient) ListenForBroadcasts(_a0 []string, _a1 chan error) {
	_m.Called(_a0, _a1)
}

// SetBroadcastHandler provides a mock function with given fields: handlerFunc
func (_m *RCONClient) SetBroadcastHandler(handlerFunc rcon.BroadcastHandlerFunc) {
	_m.Called(handlerFunc)
}

// SetDisconnectHandler provides a mock function with given fields: handlerFunc
func (_m *RCONClient) SetDisconnectHandler(handlerFunc rcon.DisconnectHandlerFunc) {
	_m.Called(handlerFunc)
}
