...
// GetByGame provides a mock function with given fields: ctx, gameName
func (_m *ServerRepo) GetByGame(ctx context.Context, gameName string) ([]*domain.Server, error) {
	ret := _m.Called(ctx, gameName)
