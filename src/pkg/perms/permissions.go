...
func init() {
	...
	registerPermissions([]Permission{
		...
		},
		{
			...
			Description: `Allows creation of player warn records.`,
			Scope:       ScopeApp,
		},
		{
			Name:        FlagCreateMute,
			DisplayName: "Log player mutes",
			Description: `Allows creation of player mute records.`,
			Scope:       ScopeApp,
		},
		{
			Name:        FlagCreateKick,
			DisplayName: "Log player kicks",
			Description: `Allows creation of player kick records.`,
			Scope:       ScopeApp,
		},
		{
			Name:        FlagCreateBan,
			DisplayName: "Log player bans",
			Description: `Allows creation of player ban records.`,
			Scope:       ScopeApp,
		},
		{
